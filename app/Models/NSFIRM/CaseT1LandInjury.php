...
/**
 * T1 detail row: land transport injury.
 *
 * Multi-row per case (`case_id` is NOT unique). Shape: id, case_id, code.
 * `code` is a foreign key to `ref_t1_land_injury.code`.
 */
class CaseT1LandInjury extends Model
{
    protected $connection = 'nsfirm';

    protected $table = 'case_t1_land_injury';
    ...
    {
        return $this->belongsTo(RefT1LandInjury::class, 'code', 'code');
    }
}
