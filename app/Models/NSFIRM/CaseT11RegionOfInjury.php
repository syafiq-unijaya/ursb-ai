...
/**
 * T11 detail row: region of injury.
 *
 * Multi-row per case (`case_id` is NOT unique). Shape: id, case_id, code.
 * `code` is a foreign key to `ref_t11_region_of_injury.code`.
 */
class CaseT11RegionOfInjury extends Model
{
    protected $connection = 'nsfirm';

    protected $table = 'case_t11_region_of_injury';
    ...
    {
        return $this->belongsTo(RefT11RegionOfInjury::class, 'code', 'code');
    }
}
