...
/**
 * T8 detail row: region of injury.
 *
 * Multi-row per case (`case_id` is NOT unique). Shape: id, case_id, code.
 * `code` is a foreign key to `ref_t8_region_of_injury.code`.
 */
class CaseT8RegionOfInjury extends Model
{
    protected $connection = 'nsfirm';

    protected $table = 'case_t8_region_of_injury';
    ...
    {
        return $this->belongsTo(RefT8RegionOfInjury::class, 'code', 'code');
    }
}
