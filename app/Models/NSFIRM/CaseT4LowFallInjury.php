...
/**
 * T4 detail row: low fall injury.
 *
 * Multi-row per case (`case_id` is NOT unique). Shape: id, case_id, code.
 * `code` is a foreign key to `ref_t4_low_fall_injury.code`.
 */
class CaseT4LowFallInjury extends Model
{
    protected $connection = 'nsfirm';

    protected $table = 'case_t4_low_fall_injury';
    ...
    {
        return $this->belongsTo(RefT4LowFallInjury::class, 'code', 'code');
    }
}
