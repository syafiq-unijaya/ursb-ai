...
/**
 * T10 detail row: region of injury.
 *
 * Multi-row per case (`case_id` is NOT unique). Shape: id, case_id, code.
 * `code` is a foreign key to `ref_t10_region_of_injury.code`.
 */
class CaseT10RegionOfInjury extends Model
{
    protected $connection = 'nsfirm';

    protected $table = 'case_t10_region_of_injury';
    ...
    {
        return $this->belongsTo(RefT10RegionOfInjury::class, 'code', 'code');
    }
}
